...
////////////////////////////////////////////////////////////////////////////////////////////////////
class VOLUME_TIMESTEPPER : public TIMESTEPPER
{
public:
  VOLUME_TIMESTEPPER(TET_STRAND_MESH& strandMesh, STRAND::STRETCHING& stretching, ENERGY_12D& eeEnergy);
  virtual ~VOLUME_TIMESTEPPER();
