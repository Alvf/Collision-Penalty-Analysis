...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
VOLUME_TIMESTEPPER::VOLUME_TIMESTEPPER(TET_STRAND_MESH& strandMesh, 
                                       STRAND::STRETCHING& stretching,
                                       ENERGY_12D& eeEnergy) :
  TIMESTEPPER(strandMesh, stretching, eeEnergy)
{
...
VOLUME_TIMESTEPPER::~VOLUME_TIMESTEPPER()
{
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
SPARSE_MATRIX VOLUME_TIMESTEPPER::buildRayleighDampingMatrix()
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
bool VOLUME_TIMESTEPPER::solveDynamics(const bool verbose)
{
...
#if 0
{
  ...
  {
    cout << "=================================================" << endl;
    cout << " STRAND::VOLUME_TIMESTEPPER RAYLEIGH SOLVE " << _currentTimestep << endl;
    cout << "=================================================" << endl;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
bool VOLUME_TIMESTEPPER::solveDynamicsWithRotation(const bool verbose, const MATRIX3& rotation, const VECTOR3& translation)
{
  TIMER functionTimer(__FUNCTION__);
  const bool veryVerbose = false;
  //const bool veryVerbose = true;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
void VOLUME_TIMESTEPPER::stiffenKinematicStrands()
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
SPARSE_MATRIX VOLUME_TIMESTEPPER::buildPlaneConstraintsOnly()
{
  TIMER functionTimer(__FUNCTION__);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
SPARSE_MATRIX VOLUME_TIMESTEPPER::buildPlaneConstraintsNoIdentity()
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
void VOLUME_TIMESTEPPER::buildConstraintMatrix()
{
  TIMER functionTimer(__FUNCTION__);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
void VOLUME_TIMESTEPPER::buildConstraintMatrixFaster()
{
  TIMER functionTimer(__FUNCTION__);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
VECTOR VOLUME_TIMESTEPPER::solveSystem(const SPARSE_MATRIX& LHS, const VECTOR& rhs)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
SPARSE_MATRIX& VOLUME_TIMESTEPPER::filteredSystem()
{
