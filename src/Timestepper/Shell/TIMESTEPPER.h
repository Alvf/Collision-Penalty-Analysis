...
{
public:
  TIMESTEPPER(TRIANGLE_MESH& triangleMesh, SHELL::STRETCHING& stretching, SHELL::BENDING& bending, ENERGY_12D& vfEnergy, ENERGY_12D& eeEnergy);
  virtual ~TIMESTEPPER();
  ...
  // release surface nodes inside a kinematic body so they can do free movement
  void releaseKinematicSurfaceConstraints(const KINEMATIC_SHAPE* shape);
