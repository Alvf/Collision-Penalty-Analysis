...
///////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////
BACKWARD_EULER_POSITION::BACKWARD_EULER_POSITION(TET_MESH& tetMesh, VOLUME::HYPERELASTIC& hyperelastic, ENERGY_12D& vfEnergy, ENERGY_12D& eeEnergy) :
  TIMESTEPPER(tetMesh, hyperelastic, vfEnergy, eeEnergy)
{
  initialize();
}

BACKWARD_EULER_POSITION::BACKWARD_EULER_POSITION(TET_MESH& tetMesh, VOLUME::HYPERELASTIC& hyperelastic, VOLUME::DAMPING& damping, ENERGY_12D& vfEnergy, ENERGY_12D& eeEnergy) :
  TIMESTEPPER(tetMesh, hyperelastic, damping, vfEnergy, eeEnergy)
{
  initialize();
}
...
bool BACKWARD_EULER_POSITION::solveRayleighDamped(const bool verbose)
{
...
#if USING_BLOCKS
  VECTOR z =_blockIminusS * _constraintTargets;
#else
...
#if USING_BLOCKS
  VECTOR rhs = _blockS * c;
#else
  VECTOR rhs = _S * c;
#endif

#if USING_BLOCKS
  BLOCK_SPARSE_MATRIX3 blockA(_A);
  BLOCK_SPARSE_MATRIX3 blockLHS = blockA.scaleLeftRightAdd(_blockS, _blockIminusS);
  SPARSE_MATRIX LHS = blockLHS.sparseView();
  ...
  std::cout << __FILE__ << " " << __FUNCTION__ << " " << __LINE__ << " : " << std::endl;
  std::cout << __FILE__ << " " << __FUNCTION__ << " " << __LINE__ << " : " << std::endl;
  cout << " A Diff: " << (LHS - ground).norm() << endl;
  cout << " LHS norm:    " << LHS.norm() << endl;
  cout << " Ground norm: " << ground.norm() << endl;
  VECTOR bGround = _S * c;
  cout << " b Diff: " << (rhs - bGround).norm() << endl;
  LHS = ground;
  */
#else
  ...
  if (verbose)
  {
    ...
    cout << " C:       " << C.norm() << endl;
    cout << " displacement: " << _tetMesh.getDisplacement().norm() << endl;
  }
#endif
...
#if USING_BLOCKS
  _velocity = _blockS * _velocity;
  _acceleration = _blockS * _acceleration;
