#ifndef BUNNY_STRAND_ONLY_DROP_H
#define BUNNY_STRAND_ONLY_DROP_H
...
class BUNNY_STRAND_ONLY_DROP : public SIMULATION_SCENE {
public:
  ...
  virtual bool buildScene() override
  {
    ...
    _sceneName = "bunny_strand_only_drop";
    _writeToFile = true;
    ...
    _triangleMeshFilename = string("../data/objs/curtain_2x2.obj");
    ...
    _initialAStrand = MATRIX3::Identity();
    // _initialAStrand = MATRIX3::Identity();
    _initialTranslationStrand = VECTOR3(-2.25, 2.0, 0.0);
    // _initialTranslationStrand = VECTOR3(2.0, -1.0, 0.0);
    ...
    _initialTranslationShell = VECTOR3(0.0, 6.2, 0.0);
