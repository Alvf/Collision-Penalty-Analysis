#ifndef BUNNY_STRAND_CLOTH_DROP_MANY_H
#define BUNNY_STRAND_CLOTH_DROP_MANY_H
...
class BUNNY_STRAND_CLOTH_DROP_MANY : public SIMULATION_SCENE {
public:
  ...
  virtual bool buildScene() override
  {
    ...
    _sceneName = "bunny_strand_cloth_drop_many";
    _writeToFile = true;
    ...
    _hybridSolver->collisionEpsEdgeEdge() = 0.07;
