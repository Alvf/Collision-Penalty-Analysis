#ifndef STRAND_DROP_H
#define STRAND_DROP_H
...
class STRAND_DROP : public SIMULATION_SCENE {
public:
  ...
  virtual bool buildScene() override
  {
    ...
    _sceneName = "STRAND_DROP";

    _spacing = 1.0;

    _gravity = VECTOR3(0,-5,0);
    ...
    VECTOR3 sphereCenter0(0,-radius - 1,0); 
    _kinematicShapes.push_back(new CUBE(sphereCenter0, radius*2));
    ...
    _eye    = VECTOR3(1.23467, -0.889582, 4.14817);
    _lookAt = VECTOR3(0.896596, -1.04489, 3.21994);
    _up     = VECTOR3(-0.0897297, 0.987118, -0.132478);
  ...
  void buildType4C()
  {
    ...
    restVertices.push_back(VECTOR3(0, 0.0, 0.0));
