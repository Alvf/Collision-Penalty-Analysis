#ifndef STRAND_END_TWEAK_H
#define STRAND_END_TWEAK_H
...
class STRAND_END_TWEAK : public SIMULATION_SCENE {
public:
  ...
  virtual bool buildScene() override
  {
    ...
    _totalPoints = 99; // decent for type 4C
