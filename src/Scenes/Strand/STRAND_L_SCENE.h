#ifndef STRAND_L_SCENE_H
#define STRAND_L_SCENE_H
...
class STRAND_L_SCENE : public SIMULATION_SCENE {
public:
  ...
  virtual void stepSimulation(const bool verbose = true) override {
    ...
    const VECTOR3 last = _strandMesh->vertices()[3];
    cout << " Last vertex: " << last.transpose() << endl;
    cout << " Angle:       " << atan(last[2] / last[1]) << endl;
