...
class TET_DEBUG : public SIMULATION_SCENE {
public:
  ...
  virtual bool buildScene() override
  {
    ...
    _filePath = string("../data/render/head_twirl") + postfix + string("/");
    string mkdir("mkdir ");
  ...
  MATRIX3 shakeHead()
  {
    ...
    */
    ...
    MATRIX3 R = rotationMatrix(axis, 0.15 * cos((4.0 / 5.0) * time * M_PI));
