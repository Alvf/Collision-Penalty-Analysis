#ifndef TET_TWIRL_SCENE_H
#define TET_TWIRL_SCENE_H
...
class TET_TWIRL_SCENE : public SIMULATION_SCENE {
public:
  ...
  TET_TWIRL_SCENE(const int strands = -1) 
  {
...
*/
  ...
  virtual bool buildScene() override
  {
    ...
    _sceneName = "twirl_wisp_slow_800_frames";
    ...
    _eye    = VECTOR3(7.36662, 10.9175, 59.9311);
    _lookAt = VECTOR3(7.24475, 10.7761, 58.9487);
    _up     = VECTOR3(0.0176621, 0.989334, -0.144589);
