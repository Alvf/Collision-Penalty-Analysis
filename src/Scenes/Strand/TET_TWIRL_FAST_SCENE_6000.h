#ifndef TET_TWIRL_FAST_SCENE_4000_H
#define TET_TWIRL_FAST_SCENE_4000_H
...
class TET_TWIRL_FAST_SCENE_4000 : public SIMULATION_SCENE {
public:
  ...
  TET_TWIRL_FAST_SCENE_4000(const int strands = -1) 
  {
  ...
  virtual bool buildScene() override
  {
    ...
    _sceneName = "twirl_wisp_4000_fast";
