#ifndef STRAND_STRAIGHTEN_H
#define STRAND_STRAIGHTEN_H
...
class DVT_STRAIGHTEN : public SIMULATION_SCENE {
public:
  ...
  DVT_STRAIGHTEN() 
  {
    ...
    //_dt = 1.0;
    //_dt = 1.0 / 3000000.0; // stable for filtered
    //_dt = 1.0 / 300000.0; // stable
    _dt = 1.0 / 30000.0; // unstable, stable for GNF
    //_dt = 1.0 / 3000.0; // unstable
    //_dt = 1.0 / 300.0; // unstable
    //_dt = 1.0 / 30.0;
  ...
  virtual bool buildScene() override
  {
   ...
   /* 
    ...
    _sceneName = "dvt_straighten_" + jitterString;
    */
    ...
    cout << " sphere 0: " << sphereCenter0.transpose() << endl;
    ...
    */
    ...
    _eye    = VECTOR3(-2.0, -1.4, 23.0);
    _lookAt = VECTOR3(-1.8, -1.6, 22.0);

    _eye    = VECTOR3(-3.28543, -2.88958, 23.0);
    _lookAt = VECTOR3(-3.09298, -3.08203, 22.0);
    _up     = VECTOR3(0,1,0);
