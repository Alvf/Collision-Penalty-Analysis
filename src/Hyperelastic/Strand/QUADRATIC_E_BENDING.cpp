...
QUADRATIC_E_BENDING::QUADRATIC_E_BENDING(const REAL& mu) :
  TAN_BENDING(mu)
{
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
std::string QUADRATIC_E_BENDING::name() const
{ 
  return std::string("QUADRATIC_E_BENDING"); 
}

///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
REAL QUADRATIC_E_BENDING::psi(const MATRIX3x2& E, const REAL& theta0) const
{
...
REAL QUADRATIC_E_BENDING::psi(const MATRIX3x2& E, const REAL& theta0, const bool inverted) const
{
  // this mirrors computation in ISOTROPIC_THETA
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
...
// gradient of theta
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX3x2 QUADRATIC_E_BENDING::gradient(const MATRIX3x2& E) const
{
	const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX3x2 QUADRATIC_E_BENDING::PK1(const MATRIX3x2& E, const REAL& theta0) const
{
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
  //const REAL cosTheta = e0.dot(e1) / (e0.norm() * e1.norm());
...
MATRIX3x2 QUADRATIC_E_BENDING::PK1(const MATRIX3x2& E, const REAL& theta0, const bool inverted) const
{
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
  //const REAL cosTheta = e0.dot(e1) / (e0.norm() * e1.norm());
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX6 QUADRATIC_E_BENDING::hessian(const MATRIX3x2& E, const REAL& theta0) const
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX6 QUADRATIC_E_BENDING::hessian(const MATRIX3x2& E, const REAL& theta0, const bool inverted) const
{
  // compute the Hessian of theta
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
...
MATRIX6 QUADRATIC_E_BENDING::clampedHessian(const MATRIX3x2& E, const REAL& theta0) const
{
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
  const REAL cosTheta = clamp(e0.dot(e1) / (e0.norm() * e1.norm()), -1.0, 1.0);
...
MATRIX6 QUADRATIC_E_BENDING::clampedHessian(const MATRIX3x2& E, const REAL& theta0, const bool inverted) const
{
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
  const REAL cosTheta = clamp(e0.dot(e1) / (e0.norm() * e1.norm()), -1.0, 1.0);
