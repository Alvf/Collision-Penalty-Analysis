...
//
// This is the full stretching + shearing energy from the original Baraff-Witkin paper,
...
#ifndef BARAFF_WITKIN_H
#define BARAFF_WITKIN_H
...
class BARAFF_WITKIN : public STRETCHING
{
public:
  BARAFF_WITKIN(const REAL& mu, const REAL& lambda);
