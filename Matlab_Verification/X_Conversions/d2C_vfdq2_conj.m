function [final] = d2C_vfdq2_conj(pk1,numstate)
%D2C_VFDQ2_CONJ Gets pk1:d2C/dx2 at state ASSUMING pk1=0;0;nonnzero stack
...
%the simple terms
for i = 1:12
    final(i,:) = final(i,:) + [0,0,0, -dbetdxnum(i)*nontriv', (dbetdxnum(i)+dgamdxnum(i))*nontriv', -dgamdxnum(i)*nontriv'];
end
